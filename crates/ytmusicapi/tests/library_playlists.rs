                                    ...
                                    "contents": [{
                                        "gridRenderer": {
                                            "items": [{
                                                ...
                                                "musicTwoRowItemRenderer": {
                                                    "title": { "runs": [{ "text": "Regional Mix", "navigationEndpoint": { "browseEndpoint": { "browseId": "VLPL777" } } }] },
                                                    "subtitle": { "runs": [{ "text": "OpenAI" }, { "text": " • " }, { "text": "15 canciones" }] },
                                                    "thumbnailRenderer": { "musicThumbnailRenderer": { "thumbnail": { "thumbnails": [] } } }
                                                }
                                            }]
                                        }
...
#[tokio::test]
async fn get_library_playlists_keeps_numeric_artist_names_before_bullet_counts() {
    let server = MockServer::start().await;
                                    ...
                                    "contents": [{
                                        "gridRenderer": {
                                            "items": [{
                                                ...
                                                "musicTwoRowItemRenderer": {
                                                    "title": { "runs": [{ "text": "Throwback Mix", "navigationEndpoint": { "browseEndpoint": { "browseId": "VLPL250" } } }] },
                                                    "subtitle": { "runs": [{ "text": "2 Chainz" }, { "text": " • " }, { "text": "18 songs" }] },
                                                    "thumbnailRenderer": { "musicThumbnailRenderer": { "thumbnail": { "thumbnails": [] } } }
                                                }
                                            }]
                                        }
...
#[tokio::test]
async fn get_library_playlists_keeps_numeric_artist_names_without_bullet_separators() {
    let server = MockServer::start().await;
                                    ...
                                    "contents": [{
                                        "gridRenderer": {
                                            "items": [{
                                                ...
                                                "musicTwoRowItemRenderer": {
                                                    "title": { "runs": [{ "text": "Club Classics", "navigationEndpoint": { "browseEndpoint": { "browseId": "VLPL500" } } }] },
                                                    "subtitle": { "runs": [{ "text": "50 Cent" }, { "text": "20 songs" }] },
                                                    "thumbnailRenderer": { "musicThumbnailRenderer": { "thumbnail": { "thumbnails": [] } } }
                                                }
                                            }]
                                        }
...
#[tokio::test]
async fn get_library_playlists_parses_comma_formatted_item_counts() {
    let server = MockServer::start().await;
                                    ...
                                    "contents": [{
                                        "gridRenderer": {
                                            "items": [{
                                                ...
                                                "musicTwoRowItemRenderer": {
                                                    "title": { "runs": [{ "text": "Huge Mix", "navigationEndpoint": { "browseEndpoint": { "browseId": "VLPL1234" } } }] },
                                                    "subtitle": { "runs": [{ "text": "OpenAI" }, { "text": " • " }, { "text": "1,234 songs" }] },
                                                    "thumbnailRenderer": { "musicThumbnailRenderer": { "thumbnail": { "thumbnails": [] } } }
                                                }
                                            }]
                                        }
...
#[tokio::test]
async fn get_library_playlists_does_not_treat_trailing_metadata_as_author() {
    let server = MockServer::start().await;
                                    ...
                                    "contents": [{
                                        "gridRenderer": {
                                            "items": [{
                                                ...
                                                "musicTwoRowItemRenderer": {
                                                    "title": { "runs": [{ "text": "Shared Mix", "navigationEndpoint": { "browseEndpoint": { "browseId": "VLPL778" } } }] },
                                                    "subtitle": { "runs": [{ "text": "OpenAI" }, { "text": " • " }, { "text": "Public playlist" }, { "text": " • " }, { "text": "15 songs" }] },
                                                    "thumbnailRenderer": { "musicThumbnailRenderer": { "thumbnail": { "thumbnails": [] } } }
                                                }
                                            }]
                                        }
...
#[tokio::test]
async fn get_library_playlists_supports_legacy_library_tab_without_selected_marker() {
    let server = MockServer::start().await;
                                    ...
                                    "contents": [{
                                        "gridRenderer": {
                                            "items": [{
                                                ...
                                                "musicTwoRowItemRenderer": {
                                                    "title": { "runs": [{ "text": "Legacy Playlist", "navigationEndpoint": { "browseEndpoint": { "browseId": "VLPLLEGACY" } } }] },
                                                    "subtitle": { "runs": [{ "text": "OpenAI" }, { "text": " • " }, { "text": "7 songs" }] },
                                                    "thumbnailRenderer": { "musicThumbnailRenderer": { "thumbnail": { "thumbnails": [] } } }
                                                }
                                            }]
...
#[tokio::test]
async fn get_library_playlists_errors_when_grid_items_are_malformed() {
    let server = MockServer::start().await;
...
#[tokio::test]
async fn get_library_playlists_errors_when_non_leading_item_is_malformed() {
    let server = MockServer::start().await;
                                    ...
                                    "contents": [{
                                        "gridRenderer": {
                                            "items": [{
                                                ...
                                                "musicTwoRowItemRenderer": {
                                                    "title": { "runs": [{ "text": "Should Not Be Reached", "navigationEndpoint": { "browseEndpoint": { "browseId": "VLPL123" } } }] },
                                                    "subtitle": { "runs": [{ "text": "OpenAI" }, { "text": " • " }, { "text": "5 songs" }] },
                                                    "thumbnailRenderer": { "musicThumbnailRenderer": { "thumbnail": { "thumbnails": [] } } }
                                                }
                                            }]
                                        }
